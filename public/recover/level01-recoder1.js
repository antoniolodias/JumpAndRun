(function() {
    ...
    function preload() {
        ...
        this.game.load.tilemap(
            "MyTilemap",
            "/assets/maps/level01/level01-map.json",
            null,
            Phaser.Tilemap.TILED_JSON
        );
        this.game.load.image("basics", "/assets/maps/tiles/basetileset.png"); //basics is the name you give to the tileset!!
    }
    ...
    function create() {
        ...
        //---------------------------------up is for tutorial stuff

        // Load the map.
        map = this.game.add.tilemap("MyTilemap");
        map.addTilesetImage("basics", "basics");
