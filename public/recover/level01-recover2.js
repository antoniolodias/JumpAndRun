(function() {
    ...
    function preload() {
        ...
        this.load.image("square", "assets/32pxsquare.png");
    ...
    function create() {
        ...
        square.create(200, 200, "square");
        cloud = this.physics.add.staticGroup();
        cloud.create(200, 200, "square");

        // this.add.image(200, 200, "floor");
        floor = this.physics.add.staticGroup();
        floor.create(0, 300, "floor");

        player = this.physics.add.sprite(0, 200, "dude");

        player.setBounce(0.2);
        player.setCollideWorldBounds(true); // colision with window
